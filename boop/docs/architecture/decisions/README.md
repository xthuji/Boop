...
新增 ADR 时复制 [python-arch-doc skill 的模板](file:///Users/huji/work/MyProject/code_mine/gitee/boop/.trae/skills/python-arch-doc/references/adr-template.md)，编号取下一个未用数字。
