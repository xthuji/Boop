...
"""
{
  "api": 1,
  "name": "Format Go",
  "description": "Professional Go code formatter and minifier.",
  "icon": "pineapple",
  "tags": ["go", "format", "minify"],
  "help": "Format or minify Go code with proper indentation and spacing.\n\nExample:\nInput:\nfunc main(){fmt.Println(\"Hello\")}\n\nOutput:\nfunc main() {\n    fmt.Println(\"Hello\")\n}\n\nIf the code is already formatted, it will be minified."
}
"""
...
def run(text, *args):
    ...
    try:
        ...
        return "Error formatting Go: {}".format(str(e))
