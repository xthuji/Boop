...
"""
{
  "api": 1,
  "name": "Format SQL",
  "description": "Professional SQL code formatter and minifier.",
  "icon": "pineapple",
  "tags": ["sql", "format", "minify"],
  "dependencies": ["sqlparse"],
  "help": "Format or minify SQL code with proper indentation and spacing.\n\nExample:\nInput:\nSELECT * FROM users WHERE id=1\n\nOutput:\nSELECT *\nFROM users\nWHERE id = 1\n\nIf the code is already formatted, it will be minified."
}
"""
...
def format_code(code):
    """Format SQL code using sqlparse with custom微调."""
